...
import com.zapcom.userRegistry.exceptions.UserAlreadyExists;
...
public class Userservice {
	...
	public User createUser(User user) {
		...
		System.err.println(userrepository.findByEmail(user.getEmail()));
		System.err.println(testUser.getName());
